...
@section('content')
                                        ...
                                        <nav>
                                            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab"
                                                    ...
                                                    aria-selected="true">PLANILLA</a>
                                                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab"
                                                    href="#nav-profile" role="tab" aria-controls="nav-profile"
                                                    aria-selected="false">RENUMERACIONES</a>
                                            </div>
                                        </nav>
                                        <form id="RegisPlanilla" class="smart-form" novalidate="novalidate">
                                            <input type="text" hidden name="idtrabajador" placeholder="DESCRIPCION....."
                                                id="idtrabajador">
                                            ...
                                            <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                                                ...
                                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                                    ...
                                                    <button type="button" title="calcular Fechas" style="margin-left: 10px"
                                                        onclick="calcularfechas();" class="btn btn-outline-success"><i
                                                            class="fa fa-calendar"> CALCULAR TOTAL DE MESES</i></button>
                                                    <fieldset>
                                                        <div class="row">
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                        class="icon-prepend fas fa-address-card"></i></i>
                                                                    <input type="text" name="dni"
                                                                        placeholder="DESCRIPCION....." id="dni">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                    ...
                                                                    <input type="text" readonly name=""
                                                                        id="nombres" placeholder="APELLIDOS Y NOMBRES">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                                <label style="color: black">FECHA INGRESO(*)</label>
                                                                <label class="input"><i
                                                                        class=" icon-prepend  fas fa-calendar-alt"></i>
                                                            ...
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                        class="icon-prepend fas fa-code"></i>
                                                                    <input type="text" name="cuspp"
                                                                        placeholder="CUSPP" id="cuspp">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                        class="icon-prepend fa fa-user"></i>
                                                                    <input type="text" id="ocupasion" name="ocupasion"
                                                                        placeholder="CARGO U OCUPASION">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">

                                                                <label class="select">
                                                                    <label style="color: black">TIPO HORAS
                                                                        EXTRAS(*)</label>
                                                                    <select name="tipos_horas_extras" id="horastrabajadas"
                                                                        aria-required="true" aria-invalid="false"
                                                                        class="valid form-control">
                                                                        <option value="0" selected=""
                                                                            disabled="">Horas Extras</option>
                                                                        <option value="1">Horas extras normales
                                                                        </option>
                                                            ...
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                        class="icon-prepend fa fa-times"></i>
                                                                    <input type="text" id="nume_horasextars"
                                                                        name="nume_horasextars"
                                                                        placeholder="Horas extras al 25%">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                        class="icon-prepend fa fa-times"></i>
                                                                    <input type="text" id="nume_horasal35"
                                                                        name="nume_horasal35"
                                                                        placeholder="Horas extras al 35%">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                                <label style="color: black">ASIGNACION FAMILIAR(*)</label>
                                                                <label title="asignacion familiar" class="input"><i
                                                                        class="icon-prepend fa fa-user"></i>
                                                                    <input type="number" readonly value="93"
                                                                        name="asigna_familiar" id="asigna_familiar"
                                                                        placeholder="ASIGNACION FAMILIAR">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                    ...
                                                                    <input type="number" onkeyup="clularHoras();"
                                                            ...
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                    ...
                                                                    <input type="number" value="0"
                                                                        onkeyup="CalcularInasistencias();" id="Faltas"
                                                                        name="Faltas" placeholder="Faltas">
                                                                </label>
                                                            </section>

                                                            <input type="hidden" id="dias_laborales"
                                                                name="dias_laborales" placeholder="Faltas">
                                                            <input type="hidden" id="total_diaslaborales"
                                                                name="total_diaslaborales" placeholder="Faltas">
                                                        ...
                                                        <strong>
                                                            <center>
                                                                <h2 style="color: black">LIQUIDACION DE BENEFICIOS SOCIALES
                                                                </h2>
                                                            </center>
                                                        </strong>
                                                        <button type="button" title="calcular cts"
                                                            style="margin-left: 10px" onclick="calcularbeneficios();"
                                                            class="btn btn-outline-success"><i class="fa fa-calculator">
                                                                CALCULAR CTS</i></button>
                                                        <button type="button" title="calcular Vacaciones"
                                                            style="margin-left: 10px" onclick="calcularVacaciones();"
                                                            class="btn btn-outline-danger"><i class="fa fa-calculator">
                                                                VACACIONES</i></button>
                                                        <button type="button" title="calcular gratificaciones"
                                                            style="margin-left: 10px" onclick="calcularGratificacion();"
                                                            class="btn btn-outline-warning"><i class="fa fa-calculator">
                                                                GRATIFICACIONES</i></button>
                                                        <br><br>
                                                        ...
                                                        <div class="row">
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                        class="icon-prepend fas fa-address-card"></i></i>
                                                                    <input type="number" readonly name="cts"
                                                                        value="0.00" placeholder="CTS" id="cts">
                                                                </label>
                                                                <input type="hidden" name="numero_fecha"
                                                                    placeholder="CTS" id="numero_fecha">
                                                            ...
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                    ...
                                                                    <input type="number" readonly value="0"
                                                                        name="vacaciones_trun"
                                                                        placeholder="VACACIONES TRUNCADAS"
                                                                        id="vacaciones_trun">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                    ...
                                                                    <input type="number" value="0.00" readonly
                                                                        name="bonificacion" id="bonificacion"
                                                                        placeholder="$.00">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                                <label style="color: black"> BONIFICACION
                                                                    EXTRAORDINARIA(*)</label>
                                                                <label class="input"><i
                                                                        class=" icon-prepend  fas fa-calendar-alt"></i>
                                                                    <input type="number" value="0.00" readonly
                                                                        name="bonificacion_extraordinaria"
                                                                        id="bonificacion_extraordinaria"
                                                                        placeholder="$.00">
                                                                </label>
                                                            </section>
                                                ...
                                                <div class="tab-pane fade" id="nav-profile" role="tabpanel"
                                                    ...
                                                    <strong>
                                                        <center>
                                                            <h2 style="color: black">INGRESOS DEL TRABAJADOR Y RENUMERACION
                                                            </h2>
                                                        </center>
                                                    </strong><br>
                                                    <button type="button" style="margin-left: 10px"
                                                        title="calcular gratificaciones"
                                                        onclick="calculalarRenumeracion();" class="btn btn-outline-info">
                                                        <i class="fa fa-calculator"> RENUMERACION</i></button>
                                                    <button type="button" style="margin-left: 10px"
                                                        id="informacion_categoria" title="Informacion de la 5 categoria"
                                                        class="btn btn-outline-danger"> <i class="fa fa-calculator"></i>
                                                        AYUDA SOBRE LA 5 CATEGORIA</button><br>


                                                    <fieldset>
                                                        <div class="row">
                                                            <section class="col col-3">
                                                                <label style="color: black"> DESCUENTO POR
                                                                    FALTAS(*)</label>
                                                                <label class="input"> <i
                                                                        class="icon-prepend fa fa-money"></i>
                                                                    <input type="number" value="0.00" readonly
                                                                        name="inasistencias" id="inasistencias"
                                                                        placeholder="$.00">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                            ...
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                        class="icon-prepend fa fa-money"></i>
                                                                    <input type="number" readonly value="0"
                                                                        name="horas_extras25" id="horas_extrasx25"
                                                                        placeholder="$.00">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                    ...
                                                                    <input type="number" value="0" readonly
                                                                        name="horas_extras35" id="horas_extrasx35"
                                                                        placeholder="$.00">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                        class="icon-prepend fa fa-car"></i>
                                                                    <input type="number" id="movilidad" name="movilidad"
                                                                        value="0.00" placeholder="$.00">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                                <label style="color: black"> ALIMENTACION(*)</label>
                                                                <label class="input"> <i
                                                                        class="icon-prepend fas fa-utensils"></i>
                                                                    <input type="number" id="alimentacion"
                                                                        name="alimentacion" value="0.00"
                                                                        placeholder="$.00">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                        class="icon-prepend fa fa-money"></i>
                                                                    <input type="number" id="bonox_Extras"
                                                                        name="bonox_Extras" value="0.00"
                                                                        placeholder="$.00">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                        ...
                                                        <strong>
                                                            <center>
                                                                <h2 style="color: black">CALCULOS FINALES</h2>
                                                            </center>
                                                        </strong>

                                                        <button type="button" style="margin-left: 10px"
                                                            title="calcular Pensiones" onclick="calculalarPensiones();"
                                                            class="btn btn-outline-dark"> <i class="fa fa-calculator">
                                                                PENSIONES</i></button>
                                                        <button type="button" style="margin-left: 10px"
                                                            title="calcular 5 Categoria" onclick="calculalar5CATEGORIA();"
                                                            class="btn btn-outline-warning"> <i
                                                                class="fa fa-calculator">CALCULO 5 CATEGORIA</i></button>
                                                        <br><br>
                                                        <div class="row">
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                        class="icon-prepend fa fa-money"></i>
                                                                    <input type="number" value="0.00" readonly
                                                                        name="total_renumeracion" id="total_renumeracion"
                                                                        placeholder="TOTAL RENUMERACION">
                                                                </label>
                                                            </section>
                                                            ...
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                        class="icon-prepend fa fa-money"></i>
                                                                    <input type="number" name="base_calculo"
                                                                        id="base_calculo" value="0.00" readonly
                                                                        placeholder="$.00">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                        class="icon-prepend fa fa-money"></i>
                                                                    <input type="text" name="tipo_seguro"
                                                                        id="tipe_Seguo" readonly
                                                                        placeholder="tipos seguros">
                                                                </label>
                                                            </section>
                                                            ...
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                        class="icon-prepend fa fa-money"></i>
                                                                    <input type="text" name="seguros" id="seguro1"
                                                                        readonly placeholder="seguro">
                                                                </label>
                                                            </section>

                                                            <input type="number" hidden name="aporte_obligatorio"
                                                                id="aporte_obligatorio" placeholder="$.00">

                                                            <input type="number" hidden name="comision_renumeracion"
                                                                id="comision_renumeracion" placeholder="$.00">

                                                            <input type="number" hidden name="prima_Seguros"
                                                                id="prima_Seguros" placeholder="$.00">
                                                            ...
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                    ...
                                                                    <input type="number" readonly
                                                                        name="aporte_obligatorio_total"
                                                                        id="aporte_obligatorio1" placeholder="$.00">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                                <label style="color: black">Comisión sobre la remuneración
                                                                </label>
                                                                <label class="input"> <i
                                                                        class="icon-prepend fa fa-money"></i>
                                                                    <input type="number" readonly
                                                                        name="comision_renumeracion_total"
                                                                        id="comision_renumeracion1" placeholder="$.00">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                        class="icon-prepend fa fa-money"></i>
                                                                    <input type="number" readonly
                                                                        name="prima_Seguros_monto" id="prima_Seguros1"
                                                                        placeholder="$.00">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                        class="icon-prepend fa fa-money"></i>
                                                                    <input type="number" readonly
                                                                        name="total_Descuento_afp"
                                                                        id="total_Descuento_afp" value="0.00">
                                                                </label>
                                                            </section>
                                                            ...
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                        class="icon-prepend fa fa-money"></i>
                                                                    <input type="number" readonly
                                                                        name="total_Descuento_onp" value="0.00"
                                                                        id="prima_Seguros_ONP" placeholder="$.00">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                                <label style="color: black">RENTA A LA 5TA
                                                                    CATEGORIA</label>
                                                                <label class="input"> <i
                                                                        class="icon-prepend fa fa-money"></i>
                                                                    <input type="number" readonly
                                                                        name="renta_5_categoria" id="renta_5_categoria"
                                                                        placeholder="$.00">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                        class="icon-prepend fa fa-money"></i>
                                                                    <input type="number" readonly
                                                                        name="renumeracion_neta" id="renumeracion_neta"
                                                                        placeholder="$.00">
                                                                </label>
                                                            </section>
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input"> <i
                                                                        class="icon-prepend fa fa-money"></i>
                                                                    <input type="number" readonly name="essalud"
                                                                        id="essalud" placeholder="$.00">
                                                                </label>

                                                            </section>
                                                            <input type="hidden" readonly name="SCTR" id="SCTR"
                                                                value="0.00" placeholder="$.00">
                                            ...
                                            <footer> <br><br>
                                                <center><button type="button" id="registrar_planilla"
                                                        class="btn btn-success">REGISTRAR PLANILLA</button></center>
    ...
    <div class="modal fade" id="calcular5categoria" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <center> <strong>
                            <h5 style="color: black ;font-family:'Arial Black' " class="modal-title"
                                id="exampleModalLabel">CALCULO IMPUESTO A LA RENTA 5TA CATEGORIA</h5>
                        </strong></center>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane container active" id="home">
                            <form id="UPDATATRABAJADOR" class="smart-form" novalidate="novalidate">
                                <!-- widget div-->
                                <input type="hidden" data-chat-id="fecha_naci" name="id_persona" id="id_persona"
                                    placeholder="Expected finish date" class="hasDatepicker valid" aria-invalid="false">
                                <input type="hidden" data-chat-id="fecha_naci" name="id_trabajador" id="id_trabajador"
                                    placeholder="Expected finish date" class="hasDatepicker valid" aria-invalid="false">
                                ...
                                <div>
                                    <div class="widget-body no-padding">
                                            ...
                                            <div class="row">
                                                ...
                                                <section class="col col-6">
                                                    ...
                                                    <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                                        <input type="number" readonly id="sueldo_anual"
                                                            name="sueldo_anual" placeholder="$.00">
                                                    </label>
                                                </section>
                                                <section class="col col-6">
                                                    <label style="color: black">GRATIFICACIONES(J/D)</label>
                                                    <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                                        <input type="number" readonly id="gratificaciones_j_d"
                                                            name="gratificaciones_j_d" placeholder="$.00">
                                                    </label>
                                                </section>
                                            </div>
                                            <div class="row">
                                                <section class="col col-6">
                                                    ...
                                                    <label class="input"> <i
                                                            class="icon-prepend fas fa-address-card"></i>
                                                        <input type="number" readonly id="bonificacion_extra"
                                                            name="bonificacion_extra" placeholder="$.00">
                                                    </label>
                                                </section>
                                                <section class="col col-6">
                                                    ...
                                                    <label class="input"> <i
                                                            class="icon-prepend fas fa-address-card"></i>
                                                        <input type="number" readonly id="total_horas"
                                                            name="total_horas" placeholder="$.00">
                                                    </label>
                                                </section>
                                            </div>
                                            <div class="row">
                                                <section class="col col-6">
                                                    ...
                                                    <label class="input"> <i class="icon-prepend fa fa-share-square"></i>
                                                        <input type="number" readonly value="0" id="vaca_trunc"
                                                            name="vaca_trunc" placeholder="$.00">
                                                    </label>
                                                </section>
                                                <section class="col col-6">
                                                    <label style="color: black">RENTA BRUTA(*)</label>
                                                    <label class="input"> <i
                                                            class="icon-prepend far fa-credit-card	"></i>
                                                        <input type="number" readonly id="renta_bruta"
                                                            name="renta_bruta" placeholder="$.00">
                                                    </label>
                                                </section>
                                            </div>
                                            ...
                                            <div class="row">
                                                <section class="col col-6">
                                                    ...
                                                    <label class="input"> <i class="icon-prepend fa fa-envelope-o"></i>
                                                        <input type="number" readonly id="total_ingre"
                                                            name="total_ingre" placeholder="$.00">
                                                    </label>
                                                </section>
                                                <section class="col col-6">
                                                    <label style="color: black">RENTA NETA(*)</label>
                                                    <label class="input"> <i class="icon-prepend fa fa-phone"></i>
                                                        <input type="number" id="renta_neta" name="renta_neta"
                                                            placeholder="$.00">
                                                    </label>
                                                </section>
                                            </div>
                                        ...
                                        <footer> <br><br>
                                            <center><button type="button" onclick="renta5categoria();"
                                                    id="CalcularCategoria" class="btn btn-dark">CALCULAR 5
                                                    CATEGORIA</button></center>
                                            <button type="button" class="btn btn-danger"
                                                data-dismiss="modal">Cerrar</button>
                            ...
                            <form id="UPDATATRABAJADOR" class="smart-form" novalidate="novalidate">
                                ...
                                <div>
                                    <div class="widget-body no-padding">
                                        <fieldset>
                                            <div class="row">
                                                ...
                                                <section class="col col-6">
                                                    ...
                                                    <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                                        <input type="number" readonly id="5uit" name="sueldo_anual"
                                                            placeholder="$.00">
                                                    </label>
                                                </section>
                                                <section class="col col-6">
                                                    ...
                                                    <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                                        <input type="number" readonly id="renta_5uit" value="0.00"
                                                            name="gratificaciones_j_d" placeholder="$.00">
                                                    </label>
                                                </section>
                                            </div>
                                            <div class="row">
                                                <section class="col col-6">
                                                    ...
                                                    <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                                        <input type="number" readonly id="20uit" value="0.00"
                                                            name="gratificaciones_j_d" placeholder="$.00">
                                                    </label>
                                                </section>
                                                <section class="col col-6">
                                                    <label style="color: black">RENTA 5TA</label>
                                                    <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                                        <input type="number" readonly id="renta_20uit" value="0.00"
                                                            name="gratificaciones_j_d" placeholder="$.00">
                                                    </label>
                                                </section>
                                            </div>
                                            <div class="row">
                                                ...
                                                <section class="col col-6">
                                                    ...
                                                    <label class="input"> <i
                                                            class="icon-prepend fas fa-address-card"></i>
                                                        <input type="number" readonly id="35uit"
                                                            name="bonificacion_extra" placeholder="$.00">
                                                    </label>
                                                </section>
                                                ...
                                                <section class="col col-6">
                                                    <label style="color: black">RENTA 5TA</label>
                                                    <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                                        <input type="number" readonly id="renta_35uit" value="0.00"
                                                            name="gratificaciones_j_d" placeholder="$.00">
                                                    </label>
                                                </section>
                                            ...
                                            <div class="row">
                                                <section class="col col-6">
                                                    ...
                                                    <label class="input"> <i
                                                            class="icon-prepend fas fa-address-card"></i>
                                                        <input type="number" readonly id="45uit" name="total_horas"
                                                            placeholder="$.00">
                                                    </label>
                                                </section>
                                                <section class="col col-6">
                                                    <label style="color: black">RENTA 5TA</label>
                                                    <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                                        <input type="number" readonly id="renta_45uit" value="0.00"
                                                            name="gratificaciones_j_d" placeholder="$.00">
                                                    </label>
                                                </section>
                                            </div>
                                            ...
                                            <div class="row">
                                                <section class="col col-6">
                                                    ...
                                                    <label class="input"> <i
                                                            class="icon-prepend fas fa-address-card"></i>
                                                        <input type="number" readonly id="45uit1" name="total_horas"
                                                            placeholder="$.00">
                                                    </label>
                                                </section>
                                                ...
                                                <section class="col col-6">
                                                    <label style="color: black">RENTA 5TA</label>
                                                    <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                                        <input type="number" readonly id="renta_45uit1" value="0"
                                                            name="gratificaciones_j_d" placeholder="$.00">
                                                    </label>
                                                </section>
                                            </div>
                                        ...
                                        <footer>
                                            <button type="button" class="btn btn-dark" onclick="sumarRentas();">SUMAR
                                                RENTAS</button>
                                            <button type="button" class="btn btn-danger"
                                                data-dismiss="modal">Cerrar</button>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <center> <strong>
                            <h5 style="color: black ;font-family:'Arial Black' " class="modal-title"
                                id="exampleModalLabel">INFORMACION DE LA QUINTA CATE</h5>
                        </strong></center>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
    ...
    <script>
        ...
        function calculalar5CATEGORIA() {
            ...
            if (inasistencias == '') {
                ...
                var sumarrentas = parseFloat(sueldo_final) + parseFloat(bonificacionfinal) + parseFloat(
                    bonificacionextrafinal) + parseFloat(total_horas);
        ...
        function sumarRentas() {
            ...
            var subtotal = parseFloat(renta1) + parseFloat(renta2) + parseFloat(renta3) + parseFloat(renta4) + parseFloat(
                renta5);
            ...
            var renumeracion_neta = parseFloat(total_renumeracion) - parseFloat(totaldescuentoAFP) - parseFloat(
                totaldescuentoONP) - parseFloat(total5categoria);
        ...
        function calculalarRenumeracion() {
            ...
            if (pagoxcademes == 0) {
                ...
                var subtotal1 = parseFloat(asisganacion_familair) + parseFloat(valorxmes1) + parseFloat(horas_extras25) +
                    parseFloat(horasextras35) + parseFloat(movilidad) + parseFloat(alimentacion) +
                ...
                var subtotal1 = parseFloat(asisganacion_familair) + parseFloat(pagoxcademes) + parseFloat(horas_extras25) +
                    parseFloat(horasextras35) + parseFloat(movilidad) + parseFloat(alimentacion) +
                    parseFloat(bonosextras) + parseFloat(otros);
                var total = parseFloat(subtotal1);
                $('#total_renumeracion').val(total.toFixed(2));
            ...
            if (vacaciones != 0) {
                ...
                if (pagoxcademes == 0) {
                    ...
                    var liquidacion1 = parseFloat(bonificacion_extra) + parseFloat(cts) + parseFloat(bonificacion) +
                        parseFloat(vacaciones) + parseFloat(pagoxcademes) + parseFloat(asisganacion_familair) + parseFloat(
                            movilidad) + parseFloat(alimentacion) +
                        parseFloat(bonosextras) + parseFloat(otros);

                    var liquidacion = parseFloat(pagoxcademes) + parseFloat(asisganacion_familair) + parseFloat(
                            vacaciones) + parseFloat(movilidad) + parseFloat(alimentacion) +
                        parseFloat(bonosextras) + parseFloat(otros);
                    ...
                    var subtotal1 = parseFloat(asisganacion_familair) + parseFloat(pagoxcademes) + parseFloat(
                            horas_extras25) + parseFloat(horasextras35) + parseFloat(movilidad) + parseFloat(alimentacion) +
            ...
            if (tipo_seguros === 0) {
                ...
                if (tipo_seguros === 'AFP') {
                    ...
                    if (base_Calculo == 0) {
                        ...
                        console.log("base_Calculo:" + base_Calculo)
                        console.log("aporte_obligatorio:" + aporte_obligatorio)
                        console.log("comision_sobre_renumeracion:" + comision_sobre_renumeracion)
                        console.log("prima_Seguros:" + prima_Seguros)
