...
<style>
    ...
    *:focus {
    ...
    .form {
        background: url('https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.facebook.com%2Fcontasystemcuenca%2F&psig=AOvVaw2hVgsTeK2fzfxfYWwca6uL&ust=1687822488720000&source=images&cd=vfe&ved=0CBEQjRxqFwoTCPjeoPDK3_8CFQAAAAAdAAAAABAX') rgba(15, 15, 15, 0.9) left top / cover no-repeat scroll;
        border-radius: 5px;
    ...
    <div id="main" role="main">
        ...
        <form method="POST" action="{{ route('login') }}" class="form">
            ...
            <div class="ctn-img-title-login">
                <img src="https://cdn4.iconfinder.com/data/icons/ios-web-user-interface-multi-circle-flat-vol-7/512/Lock_protected_safe_privacy_password_security-512.png"
                    alt="Login" title="Login" class="img-login">
            ...
            <div class="ctn-input">
                ...
                <input type="text" id="user" class="effect-input @error('usuario') is-invalid @enderror"
            ...
            <div class="ctn-input">
                ...
                <input type="password" name="password"
                    class="effect-input password @error('password') is-invalid @enderror" name="password" required
