...
<head>
    ...
    <link rel="apple-touch-startup-image"
        href="{{ asset('img/splash/ipad-landscape.png" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:landscape)') }}">
    <link rel="apple-touch-startup-image"
        href="{{ asset('img/splash/ipad-portrait.png" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:portrait)') }}">
    <link rel="apple-touch-startup-image"
        href="{{ asset('img/splash/iphone.png" media="screen and (max-device-width: 320px)') }}">
            ...
            <ul>
                ...
                @if (Auth::user()->Rol_idRol == 1)
                    <li>
                        <a href="#"><i class="fa fa-lg fa-fw fa-table"></i> <span
                                class="menu-item-parent">ADMINISTRACION</span></a>
                        <ul>
                ...
                <li>
                    <a href="#"><i class="fa fa-lg fa-fw fa-pencil-square-o"></i> <span
                            class="menu-item-parent">Planilla</span></a>
                    <ul>
                        <li>
    ...
    <div class="page-footer">
        <div class="row">
            <div class="col-xs-12 col-sm-6">
                <span href="https://www.facebook.com/deyvis.garciacercado.16" class="txt-color-white">SYS CONTA <span
                        style="cursor: pointer" class="hidden-xs"> - Desarrollado Por Ing D.G.C -
                        K.M.I</span> ©
                    2019</span>
            </div>
        </div>
...
-->
    <div id="shortcut">
        <ul>
            <li>
                <a href="https://www.youtube.com/channel/UCcZAL5gjsh4dSS_xXa92xvQ"
                    class="jarvismetro-tile big-cubes bg-color-blue"> <span class="iconbox"> <i
                            class="fas fa-chart-line fa-4x"></i> <span>Guia Contable</span> </span> </a>
            </li>
            <li>
                <a href="https://docs.google.com/document/d/1RAas6wm8yv8zT0TDbPCDxH2sKJjzMKbbBB1rWabZ-iM/edit"
                    class="jarvismetro-tile big-cubes bg-color-orangeDark"> <span class="iconbox"> <i
                            class="fas fa-chart-line fa-4x"></i> <span>Calculos Contables</span> </span> </a>
            </li>
            <li>
